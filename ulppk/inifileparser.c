...
#endif
/* Tokens.  */
#define SECTION_DECL 258
#define IDENTIFIER 259
#define STRING 260
#define NUMBER 261
#define HEXNUMBER 262
#define IPSTRING 263
...
{
      11,     0,    -1,    12,    -1,    11,    12,    -1,    13,    -1,
      12,    14,    -1,     3,    -1,    15,     9,    16,    -1,     4,
      -1,     5,    -1,     8,    -1,     6,    -1,     7,    -1
};
...
{
       0,    78,    78,    79,    82,    83,    86,    93,   110,   115,
     120,   126,   131
};
#endif
...
{
  "$end", "error", "$undefined", "SECTION_DECL", "IDENTIFIER", "STRING",
  "NUMBER", "HEXNUMBER", "IPSTRING", "'='", "$accept", "inifile",
  "section", "section_decl", "assignment", "identifier", "expression", 0
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 3:
#line 79 "inifileparser.y"
    { debug_print("INIFILE\n"); }
    break;

  case 6:
#line 86 "inifileparser.y"
    { 
							debug_print("SECTION: %s\n", (yyvsp[(1) - (1)].sval)); 
							current_sectionp = if_new_section((yyvsp[(1) - (1)].sval));
							if_add_section_node(inifilep, current_sectionp);
						}
    break;

  case 7:
#line 93 "inifileparser.y"
    {
  ...
  case 8:
#line 110 "inifileparser.y"
    { 
	  						debug_print("IDENTIFIER: %s\n", (yyvsp[(1) - (1)].sval)); 
							nodep = if_new_element((yyvsp[(1) - (1)].sval));
						}
    break;

  case 9:
#line 115 "inifileparser.y"
    { 
	  						debug_print("STRINGEXP: %s\n", (yyvsp[(1) - (1)].sval));
							nodep->element.data_type = IFDT_STRING; 
							nodep->element.szvalue = strdup((yyvsp[(1) - (1)].sval)); 
						}
    break;

  case 10:
#line 120 "inifileparser.y"
    { 
  ...
  case 11:
#line 126 "inifileparser.y"
    { 
							debug_print("NUMBEREXP: %d\n", (yyvsp[(1) - (1)].nval));
							nodep->element.data_type = IFDT_NUMBER;
							nodep->element.lvalue = (yyvsp[(1) - (1)].nval);
						}
    break;

  case 12:
#line 131 "inifileparser.y"
    { 
